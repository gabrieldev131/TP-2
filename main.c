...
int main() {
  ...
  Fila *fila_raiox = inicia_Fila();//fila de quem vai fazer/está fazendo raiox
  Fila *fila_laudo = inicia_Fila();//fila de quem vai fazer/está fazendo raiox
  ...
  for(int Unidade_de_tempo = 1;Unidade_de_tempo<43200;Unidade_de_tempo++){
    ...
    if((Unidade_de_tempo%10) == 0){
      ...
      printa_metrica(lista_controle, hospital, Unidade_de_tempo);
    }
  }
